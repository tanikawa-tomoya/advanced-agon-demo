(function () {
  ...
  class JobRegion
  {
    ...
    getRegion(container) {
      ...
      return container.querySelector('.c-confirm-dialog-region');
    }
    ...
    ensureRegion(container, zIndex) {
      ...
      if (!region) {
        ...
        region.className = 'c-confirm-dialog-region';
    ...
    isRegionEmpty(region) {
      return !region.querySelector('.c-confirm-dialog');
    }
    ...
    removeAllRegions() {
      var nodes = document.querySelectorAll('.c-confirm-dialog-region');
