(function () {
  ...
  class JobPwa
  {
    ...
    ensureManifest(source)
    {
      ...
      if (existing)
      {
        existing.setAttribute('data-pwa-downloader-manifest', '1');
        return existing;
      }
      ...
      link.rel = 'manifest';
      link.href = href;
      link.setAttribute('data-pwa-downloader-manifest', '1');
  ...
  window.Services.PwaDownloader = window.Services.PwaDownloader || {};
  window.Services.PwaDownloader.JobPwa = JobPwa;
