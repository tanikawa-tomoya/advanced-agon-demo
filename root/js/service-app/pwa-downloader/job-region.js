(function () {
  ...
  class JobRegion
  {
    ...
    getRegion(container)
    {
      ...
      return container.querySelector('.c-pwa-downloader-region');
    }
    ...
    ensureRegion(container, zIndex)
    {
      ...
      if (!region) {
        ...
        region.className = 'c-pwa-downloader-region';
    ...
    {
      return !region.querySelector('.c-pwa-downloader');
    }
    ...
    removeAllRegions()
    {
      var nodes = document.querySelectorAll('.c-pwa-downloader-region');
