(function () {
  ...
  class JobRegion
  {
    ...
    getRegion(container)
    {
      ...
      return container.querySelector('.c-print-layout-region');
    }
    ...
    ensureRegion(container, zIndex)
    {
      ...
      if (!region) {
        ...
        region.className = 'c-print-layout-region';
    ...
    isRegionEmpty(region) {
      return !region.querySelector('.c-print-layout');
    }
    ...
    removeAllRegions() {
      var nodes = document.querySelectorAll('.c-print-layout-region');
