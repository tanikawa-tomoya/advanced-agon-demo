(function () {
  ...
  class JobRegion
  {
    ...
    getRegion(container)
    {
      ...
      return container.querySelector('.c-qr-modal-region');
    }
    ...
    ensureRegion(container, zIndex)
    {
      ...
      if (!region) {
        ...
        region.className = 'c-qr-modal-region';
    ...
    isRegionEmpty(region) {
      return !region.querySelector('.c-qr-modal');
    }
    ...
    removeAllRegions() {
      var nodes = document.querySelectorAll('.c-qr-modal-region');
