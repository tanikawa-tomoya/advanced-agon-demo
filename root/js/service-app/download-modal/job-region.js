(function () {
  ...
  class JobRegion
  {
    ...
    getRegion(container)
    {
      ...
      return container.querySelector('.c-download-modal-region');
    }
    ...
    ensureRegion(container, zIndex)
    {
      ...
      if (!region) {
        ...
        region.className = 'c-download-modal-region';
    ...
    {
      return !region.querySelector('.c-download-modal');
    }
    ...
    removeAllRegions()
    {
      var nodes = document.querySelectorAll('.c-download-modal-region');
