(function ()
 {
   ...
   class AgonIndexJobView
   {
    ...
    _buildDataset()
    {
      return {
        navButtons: [
          { buttonType: 'index-nav-news', label: '最新情報', href: '/agon-event' },
          { buttonType: 'index-nav-about', label: '阿含宗とは 理念と教学', href: '/agon-about' },
          { buttonType: 'index-nav-videos', label: '映像で見る 阿含の歩み', href: '/agon-contents1' },
          { buttonType: 'index-nav-audio', label: '音声で聴く 開祖著作', href: '/agon-contents2' },
          { buttonType: 'index-nav-wellness', label: '心と体の健康のために', href: '/agon-wellness' }
        ],
        hero: {
          eyebrow: '現在の接続状況',
